...
if debug:
    ...
    filePath = '../../../data/torchFiles/210921.pkl'
    saveData = False
else:
    #read in arguments
    ...
    # load in torch datasets 
    filePath = '../../../data/torchFilesOmni/omni.pkl'
    saveData = True
...
# save model
outFile = f"../output/omni/hl_{'_'.join(str(i) for i in hiddenLayers)}_epochs_{str(epochs)}_lr_{str(learnRate)}_l2_{str(l2)}_isLin_{str(isLinear)}.pt"
if saveData:
